import { Modal, ModalOverlay, ModalContent, Button, ModalCloseButton } from "@chakra-ui/react";

function FeedbackModal({ onClose, isOpen }) {
  return (
    <Modal
      isCentered
      size={{ base: "sm", md: "md" }}
      ...
      <ModalContent>
        ...
        <form className="form feedback-form" action="">
          ...
          <Button {...css.button} type="submit">Yuborish</Button>
        </form>
      </ModalContent>
    </Modal>
  );
